...
public class CreateStoryStraight {
    public static void action(SerializableData.Instance data, Entity writer) {
        if(writer instanceof ServerPlayerEntity player) {
            ...
            StoryUtils.createStory(actionType, player, null, participants, participantMultiplier);
        }
    }
